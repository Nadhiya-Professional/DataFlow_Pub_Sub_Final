...
if __name__ == '__main__':
    ...
    pipeline_options = PipelineOptions(temp_location="gs://nm_york_cdf-_start/results/tmp",project="york-cdf-start",staging_location="gs://nm_york_cdf-_start/stage",job_name="dataflow-nad")
